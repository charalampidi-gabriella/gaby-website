...
2. quality work (important but not urgent)
3. distractions (urgent but not important)
4. waste (neither).
...
1. Name your key roles, leader, teammate, parent, plus one for your own renewal. 
2. Pick one or two important-but-not-urgent goals for each role for the coming week. 
3. Block those into the calendar before anything else. 
4. Then let the smaller, urgent tasks settle into the space that is left.
...
1. FranklinCovey, Habit 3: Put First Things First — [franklincovey.com](https://www.franklincovey.com/the-7-habits/habit-3/)
2. Toggl, The Covey Time Management Matrix: A Complete Guide — [toggl.com](https://toggl.com/blog/time-management-matrix)
